...
srwl_uti_save_intens_ascii(arP0, wfr.mesh, os.path.join(os.getcwd(), strOutDataFolderName, strPhaseOutFileName_00), 0,
...
srwl_uti_save_intens_ascii(OpticalPathDifMask, opMask.mesh,
                           os.path.join(os.getcwd(), strOutDataFolderName, strOpPathOutFileName), 0,
                           ['', 'Horizontal Position', 'Vertical Position', 'Opt. Path Diff.'],
                           _arUnits=['', 'm', 'm', 'm'])
srwl_uti_save_intens_ascii(AmpTransmitionMask, opMask.mesh,
                           os.path.join(os.getcwd(), strOutDataFolderName, strAmpTraOutFileName), 0,
                           ['', 'Horizontal Position', 'Vertical Position', 'Opt. Path Diff.'],
                           _arUnits=['', 'm', 'm', 'm'])
...
diamMask_x = (numGrids + 1) * pitch_x  # Mask diameter in x [m]
diamMask_y = (numGrids + 1) * pitch_y  # Mask diameter in y [m]
...
uti_plot2d(arI0, plotMesh0x, plotMesh0y,
           ['Horizontal Position [mm]', 'Vertical Position [mm]', 'Intensity Before Propagation'])
uti_plot1d(arI0x, plotMesh0x, ['Horizontal Position [mm]', 'Intensity [a.u.]',
                               'Intensity Before Propagation\n(cut vs horizontal position at y = 0)'])
uti_plot2d(arP0, plotMesh0x, plotMesh0y,
           ['Horizontal Position [mm]', 'Vertical Position [mm]', 'Phase Before Propagation'])
...
uti_plot2d(AmpTransmitionMask, maskPlotMeshX, maskPlotMeshY,
           ['Horizontal Position [mm]', 'Vertical Position [mm]', 'Amplitude Transmission in Mask'])
uti_plot2d(OpticalPathDifMask, maskPlotMeshX, maskPlotMeshY,
           ['Horizontal Position [mm]', 'Vertical Position [mm]', 'Optical Path Difference in Mask'])
...
uti_plot2d(arI1, plotMesh1x, plotMesh1y,
           ['Horizontal Position [mm]', 'Vertical Position [mm]', 'Intensity After Propagation'])
uti_plot1d(arI1x, plotMesh1x, ['Horizontal Position [mm]', 'Intensity [a.u.]',
                               'Intensity After Propagation\n(cut vs horizontal position at y = 0.5*pitch_y)'])
uti_plot1d(arI1y, plotMesh1y, ['Vertical Position [mm]', 'Intensity [a.u.]',
                               'Intensity After Propagation\n(cut vs vertical position at x = 0.5*pitch_x)'])
uti_plot2d(arP1, plotMesh1x, plotMesh1y,
           ['Horizontal Position [microns]', 'Vertical Position [microns]', 'Phase After Propagation'])
